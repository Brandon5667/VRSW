    ...
    <div>
      ...
      <section className="py-16 px-4">
        <div className="max-w-4xl mx-auto">
          ...
          <p className="text-gray-700 text-lg mb-6"> Through case management services and working with other community resources, VRSW assists low-income Veterans with their goal of achieving stable housing.
          </p>
